...
public interface ApplyMapper {
	...
	// 공구 수정
	public int applyUpdate(Order_reg order) throws DataAccessException;
	// 공구 신청 했는지 확인
	public int isApply(@Param("user_id") int user_id, @Param("item_id") int item_id) throws DataAccessException;
}
