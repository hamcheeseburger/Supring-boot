...
public interface WishMapper {
	...
	// 공구식품 찜하기
	public int likedItem(@Param("user_id") int user_id, @Param("item_id") int item_id, @Param("amount") int amount) throws DataAccessException;
	...
	public int updateLikedItem(WishItem wish) throws DataAccessException;

	// 찜한 식품 수량 변경 -> 식품 상세페이지에서 동일한 식품을 찜하기 했을때 사용
	public int updateQuantity(@Param("user_id") int user_id, @Param("item_id") int item_id, @Param("amount") int amount) throws DataAccessException;

	// 찜한 식품 전체 금액 가져오기
	public int totalMoney(@Param("user_id") int user_id) throws DataAccessException;

	// 찜한 식품 목록에 동일한 식품이 있는지 확인
	public int isWishItem(@Param("user_id") int user_id, @Param("item_id") int item_id) throws DataAccessException;
