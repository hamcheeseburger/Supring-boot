...
public interface ItemService {
	...
	ArrayList<Item> getItemListByKeyword(String keyword);
	
	// 진행중인 공구식품 목록 가져오기
	ArrayList<Item> getGoingItem(Item item);
	ArrayList<Item> getGoingItemByKeyword(Item item, String keyword);
			
	// 마감일 지난 공구식품 목록 가져오기
	ArrayList<Item> getEndItem(Item item);
	ArrayList<Item> getEndItemByKeyword(String keyword);
